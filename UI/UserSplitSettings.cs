            ...
            if (updateValue) {
                switch (UserSplit.Type) {
                    case SplitType.Album:
                        cboValue.DataSource = Utility.GetEnumList<SplitAlbumn>();
                        cboValue.SelectedValue = Utility.GetEnumValue<SplitAlbumn>(UserSplit.Value);
                        break;
                    case SplitType.Track:
                        cboValue.DataSource = Utility.GetEnumList<SplitTrack>();
                        cboValue.SelectedValue = Utility.GetEnumValue<SplitTrack>(UserSplit.Value);
                        break;
                    default:
